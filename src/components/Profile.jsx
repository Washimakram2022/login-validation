            ...
            <div className="row g-3 mt-3">
                ...
                <div className="col-md-4">
                    ...
                    <div className="input-group">
                        <input type="text" className="form-control" placeholder="First Name" value="Washim" />
                ...
                <div className="col-md-4">
                    ...
                    <div className="input-group">
                        <input type="text" className="form-control" placeholder="First Name" value="Akram"  />
                        <span className="input-group-text" id="basic-addon1">
                            <i className="fa-solid fa-pen-to-square"></i>
                        </span>
                    </div>
                ...
                <div className="col-md-4">
                    ...
                    <div className="input-group">
                        ...
                        <input type="text" className="form-control" placeholder="29-11-1991" />
                    </div>
                </div>
                ...
                <div className="col-md-4">
                    ...
                    <select className="form-select" id="validationDefault04" required>
                        <option selected disabled value="">AB+</option>
                        <option>B+</option>
                        <option>B-</option>
                        <option>...</option>
                    </select>
                ...
                <div className="col-md-4">
                    ...
                    <select className="form-select">
                        <option selected disabled value="">Aadhar Card</option>
